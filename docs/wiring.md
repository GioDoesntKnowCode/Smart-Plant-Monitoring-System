...
⚡ = GPIO-switched power. Sensor only powered during a read, then off.
    Prevents heat build-up and probe corrosion on the resistive moisture sensor.
```
...
|---|---|---|---|
| VCC (red) | Pin 34 | GP28 | GPIO-switched ⚡ |
